...
<tr>
   ...
   <tr><td bgcolor="brown" align=center height="70" valign="bottom"><h2><font color="white" face="Comic Sans Ms">Create your new account</font></h2></td></tr>
   ...
   <tr><td align="center"><font face="Comic Sans Ms" size=5 >
		<form name="DisplayDetails"  ACTION="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
			...
			<tr><td><input type="text" name="uname" id="uname" size="70" placeholder="Enter Your Name" style="height:40"><br></td></tr>
			...
			<tr align=center><td><input type="submit" name="submit" id="submit" size="70"  value="Signup" class="button cursor"><br></td></tr>
   ...
   if(isset($_POST["submit"])){
	   ...
	   $ph = $_POST['phone'];
	   $ps = $_POST['pswd'];
	   $sql = "insert into mystudent value('$un','$ph','$ps')";
	   if($conn->query($sql)=== TRUE){
		   echo "Thank you for connecting to us :) ";
	   }
	   else {
		   echo "Error!!";
	   }
